...
type GoodsClient interface {
	...
	// 删除商品
	DeleteGoods(ctx context.Context, in *GoodInfoRequest, opts ...grpc.CallOption) (*Empty, error)
	// 商品分类
	// 获取所有的分类
...
func (c *goodsClient) DeleteGoods(ctx context.Context, in *GoodInfoRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type GoodsServer interface {
	...
	// 删除商品
	DeleteGoods(context.Context, *GoodInfoRequest) (*Empty, error)
	// 商品分类
	// 获取所有的分类
...
func (UnimplementedGoodsServer) DeleteGoods(context.Context, *GoodInfoRequest) (*Empty, error) {
...
func _Goods_DeleteGoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).DeleteGoods(ctx, req.(*GoodInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
